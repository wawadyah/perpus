...
<div class="grid grid-cols-3 gap-4">
    ...
    <a href="#" class="grid grid-cols-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <div>
